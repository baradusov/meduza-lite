...
export const generateRss = (items) => {
  ...
  <rss xmlns:atom="http://www.w3.org/2005/Atom" version="2.0">
    <channel>
      <title>Meduza.io</title>
      <link>https://meduza-lite.vercel.app</link>
      <language>ru</language>
      <atom:link href="https://meduza-lite.vercel.app/rss.xml" rel="self" type="application/rss+xml"/>
      ${items
        .map((item) => {
          return `
          <item>
            <title><![CDATA[${item.title}]]></title>
            <link>${item.link.replace('https://meduza.io', 'https://meduza-lite.vercel.app')}</link>
            <guid>${item.guid.replace('https://meduza.io', 'https://meduza-lite.vercel.app')}</guid>
